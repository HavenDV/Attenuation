...
${OBJECTDIR}/geom/Angle.o: geom/Angle.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/Angle.o geom/Angle.cpp

${OBJECTDIR}/geom/CVector2D.o: geom/CVector2D.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/CVector2D.o geom/CVector2D.cpp

${OBJECTDIR}/geom/Circle.o: geom/Circle.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/Circle.o geom/Circle.cpp

${OBJECTDIR}/geom/CompoundObject.o: geom/CompoundObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/CompoundObject.o geom/CompoundObject.cpp

${OBJECTDIR}/geom/Ellipse.o: geom/Ellipse.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/Ellipse.o geom/Ellipse.cpp

${OBJECTDIR}/geom/GeometricRelation.o: geom/GeometricRelation.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/GeometricRelation.o geom/GeometricRelation.cpp

${OBJECTDIR}/geom/Line.o: geom/Line.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/Line.o geom/Line.cpp

${OBJECTDIR}/geom/Parser.o: geom/Parser.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/Parser.o geom/Parser.cpp

${OBJECTDIR}/geom/Ring.o: geom/Ring.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/Ring.o geom/Ring.cpp

${OBJECTDIR}/geom/Segment.o: geom/Segment.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/Segment.o geom/Segment.cpp

${OBJECTDIR}/geom/SemiCircle.o: geom/SemiCircle.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/SemiCircle.o geom/SemiCircle.cpp

${OBJECTDIR}/geom/TestPhantom.o: geom/TestPhantom.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/TestPhantom.o geom/TestPhantom.cpp

${OBJECTDIR}/geom/io/svg/SvgDocument.o: geom/io/svg/SvgDocument.cpp 
	${MKDIR} -p ${OBJECTDIR}/geom/io/svg
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/geom/io/svg/SvgDocument.o geom/io/svg/SvgDocument.cpp
...
${OBJECTDIR}/report/ReportHelper.o: report/ReportHelper.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/report/ReportHelper.o report/ReportHelper.cpp

${OBJECTDIR}/report/chart/SvgChart.o: report/chart/SvgChart.cpp 
	${MKDIR} -p ${OBJECTDIR}/report/chart
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/report/chart/SvgChart.o report/chart/SvgChart.cpp

${OBJECTDIR}/rude/AbstractData.o: rude/AbstractData.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/AbstractData.o rude/AbstractData.cpp

${OBJECTDIR}/rude/AbstractOrganiser.o: rude/AbstractOrganiser.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/AbstractOrganiser.o rude/AbstractOrganiser.cpp

${OBJECTDIR}/rude/AbstractParser.o: rude/AbstractParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/AbstractParser.o rude/AbstractParser.cpp

${OBJECTDIR}/rude/AbstractWriter.o: rude/AbstractWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/AbstractWriter.o rude/AbstractWriter.cpp

${OBJECTDIR}/rude/Base64Encoder.o: rude/Base64Encoder.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/Base64Encoder.o rude/Base64Encoder.cpp

${OBJECTDIR}/rude/Comment.o: rude/Comment.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/Comment.o rude/Comment.cpp

${OBJECTDIR}/rude/ConfigImpl.o: rude/ConfigImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/ConfigImpl.o rude/ConfigImpl.cpp

${OBJECTDIR}/rude/DataLine.o: rude/DataLine.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/DataLine.o rude/DataLine.cpp

${OBJECTDIR}/rude/File.o: rude/File.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/File.o rude/File.cpp

${OBJECTDIR}/rude/KeyValue.o: rude/KeyValue.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/KeyValue.o rude/KeyValue.cpp

${OBJECTDIR}/rude/ParserJuly2004.o: rude/ParserJuly2004.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/ParserJuly2004.o rude/ParserJuly2004.cpp

${OBJECTDIR}/rude/RealOrganiser.o: rude/RealOrganiser.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/RealOrganiser.o rude/RealOrganiser.cpp

${OBJECTDIR}/rude/Section.o: rude/Section.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/Section.o rude/Section.cpp

${OBJECTDIR}/rude/WhiteSpace.o: rude/WhiteSpace.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/WhiteSpace.o rude/WhiteSpace.cpp

${OBJECTDIR}/rude/Writer.o: rude/Writer.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/Writer.o rude/Writer.cpp

${OBJECTDIR}/rude/config.o: rude/config.cpp 
	${MKDIR} -p ${OBJECTDIR}/rude
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rude/config.o rude/config.cpp

${OBJECTDIR}/simulation/Simulation.o: simulation/Simulation.cpp 
	${MKDIR} -p ${OBJECTDIR}/simulation
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/simulation/Simulation.o simulation/Simulation.cpp

${OBJECTDIR}/sources/FanSource.o: sources/FanSource.cpp 
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/FanSource.o sources/FanSource.cpp

${OBJECTDIR}/sources/SourceBase.o: sources/SourceBase.cpp 
	${MKDIR} -p ${OBJECTDIR}/sources
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/SourceBase.o sources/SourceBase.cpp

${OBJECTDIR}/util/NumericComparator.o: util/NumericComparator.cpp 
	${MKDIR} -p ${OBJECTDIR}/util
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/NumericComparator.o util/NumericComparator.cpp

${OBJECTDIR}/util/StringUtils.o: util/StringUtils.cpp 
	${MKDIR} -p ${OBJECTDIR}/util
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/StringUtils.o util/StringUtils.cpp

${OBJECTDIR}/util/SvgFile.o: util/SvgFile.cpp 
	${MKDIR} -p ${OBJECTDIR}/util
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/util/SvgFile.o util/SvgFile.cpp
